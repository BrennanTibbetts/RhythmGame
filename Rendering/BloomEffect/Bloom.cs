...
namespace BloomPostprocess
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            renderTarget3 = new RenderTarget2D(GraphicsDevice, 800, 480, false, format, DepthFormat.None);
        }
        ...
        {
            if (sceneRenderTarget!= null) sceneRenderTarget.Dispose();
            if (renderTarget1 != null)  renderTarget1.Dispose();
            if (renderTarget2 != null)  renderTarget2.Dispose();
        }
        ...
        /// </summary>
        public RenderTarget2D Draw(GameTime gameTime, RenderTarget2D renderTarget)
        {
            ...
            if (bloomCombineEffect.Parameters["BaseTexture"] == null)
            {
                throw new Exception();
            }
